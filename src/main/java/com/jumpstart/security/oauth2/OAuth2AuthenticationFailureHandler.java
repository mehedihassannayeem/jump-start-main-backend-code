...
import static com.jumpstart.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
import com.jumpstart.util.CookieUtils;
...
public class OAuth2AuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {
	...
	/**
	 * if the OAuth request is failed for some reason this method will invoke
	 */
	@Override
